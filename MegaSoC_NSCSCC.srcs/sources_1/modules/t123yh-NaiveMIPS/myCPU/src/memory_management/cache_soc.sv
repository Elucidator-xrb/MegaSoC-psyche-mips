...
logic w_out_isram_valid, w_out_dsram_valid, w_dcache_valid, w_icache_valid, r_rw_stall;
...
assign o_d_valid = (!i_d_cached && w_out_dsram_valid) | (i_d_cached && w_dcache_valid && !(r_rw_stall));
...
always_ff @(posedge i_clk) begin
    if(i_rst)begin
        ...
        r_rw_stall <= i_d_write && w_dcache_valid && !r_rw_stall;
    end
end
